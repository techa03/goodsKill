                ...
                for (RowData rowData : rowChange.getRowDatasList()) {
                    if (eventType == EventType.DELETE) {
                        ...
                        if (present) {
                            ...
                            CANAL_RESPONSE_LIST.add(SeckillMockCanalResponseDTO.builder()
                                    .seckillId(Long.parseLong(column.getValue())).status(true)
                                    .note("canal seckill end")
                                    .build());
                            log.warn("商品id:{}, 秒杀结束！！！！！！！！", column.getValue());
                        }
                    }
                }
            }
