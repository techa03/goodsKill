...
``master``分支基于最新Spring Cloud 2022.x+ Spring Boot 3.x体系构建，由于Shiro兼容性问题以及个人精力有限已移除前端JSP页面、登录注册以及后台管理功能，目前仅保留核心的模拟接口，如需使用Boot 2.7.x版本可以切换到tag https://github.com/techa03/goodsKill/tree/v2.7.4[v2.7.4]。
